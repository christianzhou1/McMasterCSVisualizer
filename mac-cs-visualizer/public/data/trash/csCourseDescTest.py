...
test_course_link = "https://academiccalendars.romcmaster.ca/preview_course_nopop.php?catoid=56&coid=278847"

# --------------------------------------------------------------

directory = "cs course pages"
continue_index = courses.index(next(course for course in courses if course['link'] == test_course_link))

# course = courses[2]
for i in range(continue_index, len(courses)):
  course = courses[i]
